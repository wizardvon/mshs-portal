...
export function SummaryCard({ label, value, detail, icon: Icon }: SummaryCardProps) {
  return (
    <article className="group rounded-2xl border border-slate-200 bg-white p-5 shadow-sm shadow-slate-200/70 transition hover:-translate-y-0.5 hover:border-red-100 hover:shadow-md">

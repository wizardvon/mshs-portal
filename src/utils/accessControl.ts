...
export const defaultModulePermissionsByRole: Record<UserRole, AppModule[]> = {
  ...
  master_teacher: ["dashboard", "announcements", "loading", "teachers", "subjects", "sections", "dll_submissions", "document_requests", "tosia_pro", "mps", "grade_computation", "grade_submissions", "grade_summary", "observations", "personnel_locator", "my_personnel_attendance", "teacher_loads", "printable_certificates", "reports", "personnel_settings"],
  teacher: ["dashboard", "announcements", "loading", "dll_submissions", "document_requests", "tosia_pro", "mps", "grade_computation", "grade_submissions", "grade_summary", "observations", "personnel_locator", "my_personnel_attendance", "teacher_loads", "printable_certificates", "reports", "personnel_settings"],

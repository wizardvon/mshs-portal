...
export const defaultModulePermissionsByRole: Record<UserRole, AppModule[]> = {
  ...
  principal: ["dashboard", "loading", "teacher_loads", "reports", "scheduler"],
  master_teacher: ["dashboard", "loading", "teachers", "subjects", "sections", "teacher_loads", "reports"],
  teacher: ["dashboard", "loading", "teacher_loads", "reports"],
